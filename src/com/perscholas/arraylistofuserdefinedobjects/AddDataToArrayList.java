package com.perscholas.arraylistofuserdefinedobjects;
...
//In the above class, as a demonstration, we are passing Data to Book class by
//using the constructor, and by using the setter method.